...
public interface ExecutedTestCaseRepository extends JpaRepository<ExecutedTestCase, Long> {
    ...
    /**
     * @Description fetches list of aut names from executed test cases
    ...
    /**
     * @Description fetches list of test case versions from executed test cases
    ...
    /**
     * @Description fetches list of custom defined results
    ...
    /**
     * @Description fetches list of custom defined time response results
     * @param autName - aut name
    ...
    /**
     * @Description fetches list of custom defined count response results
